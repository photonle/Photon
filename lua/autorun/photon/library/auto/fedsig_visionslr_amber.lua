...
COMPONENT.Sections = {
	...
	["auto_fedsig_visionslr_amber_traffic"] = {
		{ { 8, A }, { 9, A }, { 10, A }, { 11, A } },
		{ { 12, A }, { 13, A } },
		{ { 9, A }, { 11, A }, { 13, A } },
		{ { 8, A }, { 10, A }, { 12, A } },
...
COMPONENT.Modes = {
	Primary = {
			M1 = {
				...
				["auto_fedsig_visionslr_amber_traffic"] = "code1",
			},
			M2 = {
				["auto_fedsig_visionslr_amber"] = "code2",
				["auto_fedsig_visionslr_amber_traffic"] = "warn",
			},
			M3 = {
				["auto_fedsig_visionslr_amber"] = "code3",
				["auto_fedsig_visionslr_amber_traffic"] = "warn",
			}
		},
	Auxiliary = {
			L = {
				["auto_fedsig_visionslr_amber_traffic"] = "left"
			},
			R = {
				["auto_fedsig_visionslr_amber_traffic"] = "right"
			},
			D = {
				["auto_fedsig_visionslr_amber_traffic"] = "diverge"
			}
		},
	Illumination = {
		T = {
